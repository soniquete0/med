            ...
            React.createElement("section", { className: 'hero', style: { backgroundImage: image && "url(" + getImageUrl(image) + ")" } },
                ...
                React.createElement("div", { className: 'container' },
                    React.createElement("div", { className: 'hero__holder' },
                        ...
                        displaySearch && (React.createElement(SearchBar, { placeholder: placeholder ? placeholder : 'Hledat ...', barColor: 'lightBlue', blogSearchResults: this.props.data.blogSearchResults, doctorsLink: this.props.data.doctorsLink })))))));
    };
    return Hero;
}(React.Component));
export default Hero;
