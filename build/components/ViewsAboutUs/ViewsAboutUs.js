    ...
    return (React.createElement("div", { className: 'viewsAboutUs' },
        React.createElement("div", { className: 'container' },
            ...
            React.createElement("div", { className: 'grid viewsAboutUs__list' },
                React.createElement(List, { data: views }, function (_a) {
                    var data = _a.data;
                    return data && data.map(function (item, i) {
                        return (React.createElement(ViewsAboutUsElement, { key: i, url: item.url, link: item.link, cite: item.cite, image: item.image }));
                    });
                })))));
};
