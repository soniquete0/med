...
var MapBox = function (props) {
    ...
    return (React.createElement("div", { className: 'mapBox' },
        ...
        React.createElement("div", { className: 'mapBox__img' }, image && image.filename && React.createElement(Media_1.default, { type: "image", data: image })),
        ...
        React.createElement("div", { className: 'mapBox__contacts' },
            ...
            React.createElement("div", { className: 'mapBox__mobile__img' }, image && image.filename && React.createElement(Media_1.default, { type: "image", data: image }))),
        React.createElement("div", { className: 'mapBox__buttons' },
            React.createElement(Link_1.default, __assign({}, ambulanceLink),
                React.createElement(Button_1.default, { classes: "btn--small btn--blueBkg", noArrow: true }, "ambulance")),
            React.createElement(Link_1.default, { urlNewWindow: true, url: "https://www.google.com/maps/search/?api=1&query=" + title + "+medicon+" + address + "+" + city },
                React.createElement(Button_1.default, { classes: "btn--small btn--blueBorder" }, "kudy k n\u00E1m")))));
};
