...
var TemporaryPopup = function (_React$Component) {
  _inherits(TemporaryPopup, _React$Component);

  function TemporaryPopup(props) {
    var _this;

    _classCallCheck(this, TemporaryPopup);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(TemporaryPopup).call(this, props));
  ...
  _createClass(TemporaryPopup, [{
    key: "render",
    value: function render() {
      return React.createElement("div", {
        className: "temporaryPopup ".concat(this.state.active ? '' : 'temporaryPopup--disabled', " ")
