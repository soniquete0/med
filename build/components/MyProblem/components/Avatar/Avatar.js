...
var Avatar = function (props) {
    ...
    return (React.createElement("div", { className: "avatar " + activeArea },
        React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", x: "0px", y: "0px", viewBox: "0 0 579 692", xmlSpace: "preserve" },
            ...
            React.createElement("circle", { className: "avatar__area avatar__eye avatar__lEye", cx: "324.1", cy: "101.1", r: "8.6", onClick: function () { return onClick('lEye'); } }),
            React.createElement("circle", { className: "avatar__area avatar__eye AVATAR__rEye", cx: "256.1", cy: "101.1", r: "8.6", onClick: function () { return onClick('rEye'); } }),
            React.createElement("path", { onClick: function () { return onClick('mouth'); }, className: "avatar__area avatar__mouth", d: "M321.2,151c0,0-7.6,18.6-31.6,18.6c-24.4,0-31.6-18.6-31.6-18.6" }),
            React.createElement("path", { className: "avatar__area avatar__nose", d: "M295.7,128.5c0,0-1.5,4-6,4c-4.6,0-6-4-6-4", onClick: function () { return onClick('nose'); } }),
            React.createElement("path", { className: "avatar__area avatar__eyebrow", d: "M322.5,71.5c7.3,1.8,13.9,4.8,19.5,8.7", onClick: function () { return onClick('eyebrow'); } }),
