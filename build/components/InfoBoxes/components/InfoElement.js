...
export default function InfoElement(props) {
    var title = props.title, gradientColor = props.gradientColor, image = props.image, button = props.button, titleColor = props.titleColor;
    return (React.createElement("a", { className: 'info-boxes__list__element', style: { backgroundImage: "url(/assets/medicon/images/info-el-2.jpg)" } },
        React.createElement("div", { className: 'fullWidthContainer info-boxes__list__element__content' },
            ...
            button &&
                React.createElement(Button, { classes: 'btn--fullWidth ' + button }, "vice info")),
