...
var SvgIcon = function (props) {
    switch (props.name) {
        case 'fb':
            return (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", preserveAspectRatio: "none" }, props, { className: "svgIcon fbIcon " + ('svgIcon--' + props.type) }),
        ...
        case 'arrow': {
            return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", preserveAspectRatio: "none", className: "svgIcon arrowIcon " + ('svgIcon--' + props.type) },
