...
var SvgIcon = function (props) {
    switch (props.name) {
        case 'fb':
            return (React.createElement("svg", __assign({ viewBox: "0 0 512 512" }, props, { className: "svgIcon fbIcon " + ('svgIcon--' + props.type) }),
        ...
        case 'close': {
            return (React.createElement("svg", { viewBox: "0 0 50 50", className: "svgIcon closeIcon " + ('svgIcon--' + props.type) },
        ...
        case 'arrow': {
            return (React.createElement("svg", { viewBox: "0 0 100 100", className: "svgIcon arrowIcon " + ('svgIcon--' + props.type) },
        ...
        case 'search': {
            return (React.createElement("svg", { viewBox: "0 0 250.313 250.313", className: "svgIcon searchIcon " + ('svgIcon--' + props.type) },
        ...
        case 'download': {
            return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", x: "0px", y: "0px", viewBox: "0 0 489.701 489.701", className: "svgIcon downloadIcon " + ('svgIcon--' + props.type) },
