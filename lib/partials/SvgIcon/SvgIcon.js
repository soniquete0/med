  ...
  switch (props.name) {
    case 'fb':
      return React.createElement("svg", __assign({
        ...
        className: "svgIcon fbIcon " + ('svgIcon--' + type)
    ...
    case 'close':
      {
        return React.createElement("svg", {
          viewBox: "0 0 50 50",
          className: "svgIcon closeIcon " + ('svgIcon--' + type)
        }, React.createElement("path", {
    ...
    case 'arrow':
      {
        return React.createElement("svg", {
          viewBox: "0 0 100 100",
          className: "svgIcon arrowIcon " + ('svgIcon--' + type)
        }, React.createElement("path", {
    ...
    case 'search':
      {
        return React.createElement("svg", {
          ...
          className: "svgIcon searchIcon " + ('svgIcon--' + type)
        }, React.createElement("path", {
