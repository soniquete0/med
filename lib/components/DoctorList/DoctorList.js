    ...
    return React.createElement(_List.default, {
      ...
      return React.createElement("section", {
        ...
        return React.createElement("div", {
          ...
          className: 'doctorList__item__info'
        }, React.createElement("h3", null, doc.name), React.createElement("p", null, doc.field), React.createElement(_Link.default, __assign({}, doc.clinicUrl, {
          className: 'doctorList__item__info__link'
      ...
      }, "zobrazit ", _this.state.showMore ? "m\xE9n\u011B" : "vice", React.createElement("span", {
        className: "arrow " + (_this.state.showMore ? "arrow--up" : "arrow--down") + "  "
      }))) : ''));
    });
  };
