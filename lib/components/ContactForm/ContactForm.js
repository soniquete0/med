  ...
  ContactForm.prototype.render = function () {
    ...
    return React.createElement("div", {
      ...
      return React.createElement("section", {
        ...
        className: "form__input active   " + (errors.name ? 'error' : '')
      }, React.createElement("input", {
        value: name,
        type: "text",
        name: "name",
        className: "" + (_this.state.formValues.name ? 'active' : ''),
      ...
      })), React.createElement("div", null, "Souhlas\xEDm se ", React.createElement(_Link.default, __assign({}, gdprLink), "zpracov\xE1n\xEDm osobn\xEDch"), " \xFAdaj\u016F.")), React.createElement("div", {
