...
function (_super) {
  ...
  Footer.prototype.render = function () {
    ...
    return React.createElement("footer", {
      ...
      var data = _a.data;
      return React.createElement(React.Fragment, null, data && data.length > 0 && React.createElement("ul", {
        className: 'footer__list'
      }, data.slice(0, 5).map(function (link, index) {
        return React.createElement("li", {
          key: index
        }, React.createElement("a", {
          href: link.url
        }, link.text));
      })), data && data.length > 5 && React.createElement("ul", {
        className: 'footer__list'
      }, data.slice(5, 10).map(function (link, index) {
        return React.createElement("li", {
          key: index
        }, React.createElement("a", {
          href: link.url
        }, link.text));
      })), data && data.length > 10 && React.createElement("ul", {
        className: 'footer__list'
      }, data.slice(10, 15).map(function (link, index) {
        return React.createElement("li", {
          key: index
        }, React.createElement("a", {
          href: link.url
