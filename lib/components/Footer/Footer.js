...
function (_super) {
  ...
  Footer.prototype.render = function () {
    ...
    return React.createElement("footer", {
      className: 'footer'
    }, React.createElement(_HelpPopup["default"], null), React.createElement(_TemporaryPopup["default"], null), React.createElement(_CookiePopup["default"], null), React.createElement("div", {
      className: "container"
    ...
    }, company && React.createElement("p", null, company), text && React.createElement(_Link["default"], __assign({}, url), React.createElement("p", null, text))))));
  };
