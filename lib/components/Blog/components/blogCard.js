...
function BlogCard(props) {
  ...
  return React.createElement(_Link.default, {
    pageId: id,
    className: 'blogCard'
  }, title && React.createElement("h3", null, React.createElement(_reactLinesEllipsis.default, {
    text: title,
    maxLine: "3",
    ellipsis: "...",
    basedOn: "letters",
    trimRight: true
  })), text && React.createElement("p", null, text), img && React.createElement(_Media.default, {
    data: img,
    type: "image"
