    ...
    return React.createElement("div", {
      ...
      if (data.length > 0) {
        return React.createElement("ul", {
          ...
          }, React.createElement(_Link.default, __assign({}, doctor.link), React.createElement("span", null, React.createElement("p", null, React.createElement("span", null, doctor.name), React.createElement("span", null, doctor.isDoctorActive ? 'ordinuje' : 'neordinuje')), React.createElement("p", null, doctor.speciality)), React.createElement("span", null, doctor.clinic)));
        }));
      } else {
        return React.createElement("div", {
          className: 'searchBarResults__noResults'
        }, "Bohu\u017Eel jsme nenalezli \u017E\xE1dn\xE9ho l\xE9ka\u0159e.");
      }
