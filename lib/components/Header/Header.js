...
function (_super) {
  ...
  Header.prototype.render = function () {
    ...
    return React.createElement("header", {
      ...
      alt: "Medicon Logo"
    }))), React.createElement("nav", null, React.createElement("ul", null, mainNav && mainNav.map(function (navItem, i) {
    ...
    }, React.createElement("ul", null, secondaryNav && secondaryNav.map(function (navItem, i) {
      return React.createElement("li", {
        key: i
      }, React.createElement(_Link.default, {
        url: navItem.url,
