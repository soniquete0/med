...
function (_super) {
  ...
  MapComponent.prototype.render = function () {
      ...
      clinics.forEach(function (clinic, index) {
        if (clinic.lat && clinic.lng) {
          markers.push(React.createElement(_Marker.default, {
            type: clinic.name === _this.nearestClinic(_this.props.coords ? _this.props.coords.latitude : defaultCenter.lat, _this.props.coords ? _this.props.coords.longitude : defaultCenter.lng).name ? 'big' : 'small',
            lat: clinic.lat,
            lng: clinic.lng,
    ...
    }, markers), this.state.activeMarker && React.createElement(_MapBox.default, {
