    ...
    return React.createElement("div", {
      ...
      if (clinic.lat && clinic.lng) {
        return React.createElement(_Marker.default, {
          type: clinic.title === _this.nearestClinic(_this.props.coords ? _this.props.coords.latitude : defaultCenter.lat, _this.props.coords ? _this.props.coords.longitude : defaultCenter.lng, _this.props.clinics).title ? 'big' : 'small',
