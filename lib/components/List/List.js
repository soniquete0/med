...
function (_super) {
  ...
  List.prototype.render = function () {
    ...
    if (data && data.sourceType === 'pages') {
      return React.createElement(React.Fragment, null, React.createElement(AllPagesComposedQuery, null, function (_a) {
        var _b = _a.allPages,
        ...
        return _this.props.children({
          data: data.orderBy ? pagesWithTag.sort(function (a, b) {
            if (data.order === 'DESC') {
              if (a.orderBy > b.orderBy) {
                return -1;
              }
