...
import { Dummy, Header, DoctorList, PolyclinicsList, ExpertiseList, Blog, MyProblem, JobPositions, MedicalGroup, Timeline, ContactForm } from '../../components';
