...
const SvgIcon: React.SFC<ISvgIconProps> = props => {
  switch (props.name) {
    case 'fb':
      return (
        <svg viewBox="0 0 512 512" {...props} className={`svgIcon fbIcon ${'svgIcon--' + props.type}`}>
    ...
    case 'close': {
      return (
        <svg viewBox="0 0 50 50" className={`svgIcon closeIcon ${'svgIcon--' + props.type}`}>
    ...
    case 'arrow': {
      return (
        <svg viewBox="0 0 100 100" className={`svgIcon arrowIcon ${'svgIcon--' + props.type}`}>
    ...
    case 'search': {
      return (
        <svg viewBox="0 0 250.313 250.313" className={`svgIcon searchIcon ${'svgIcon--' + props.type}`}>
    ...
    default:
      return <div>THERE WAS ERROR Renering SVG Icon</div>;
  }
};
